...
void AIDuke::EnableBlastPushBack() {
	if (dukeCharacter.state == DukeState::INVULNERABLE) return;
	if (dukeCharacter.state == DukeState::CHARGE) return;
	if (dukeCharacter.state == DukeState::CHARGE_ATTACK) return;
