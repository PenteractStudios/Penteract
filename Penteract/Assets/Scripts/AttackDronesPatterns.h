...
extern inline std::vector<AttackDronesPattern> patterns = {
	...
	AttackDronesPattern(2.0f, 4.0f, 6.0f, 2.0f, 3.0f,
						0.3f, 7, DronesFormation::LINE, 5, 0.5f,
						{ WaveCycle::LEFT_TO_RIGHT, WaveCycle::RIGHT_TO_LEFT, WaveCycle::LEFT_TO_RIGHT, WaveCycle::RIGHT_TO_LEFT, WaveCycle::LEFT_TO_RIGHT, WaveCycle::CENTERED },
						15,
						false, false, 0.0f,
						17.0f),

	AttackDronesPattern(3.0f, 4.0f, 4.0f, 2.0f, 2.0f,
						0.1f, 8, DronesFormation::CIRCLE, 12, 0.5f,
