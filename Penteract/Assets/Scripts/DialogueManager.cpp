...
void DialogueManager::Start() {
	...
	dialoguesArray[3] = Dialogue(DialogueWindow::FANG, true, "I might be able to\nseize its power\nfor ourselves if we find\na couple more.", &dialoguesArray[4]);

	dialoguesArray[4] = Dialogue(DialogueWindow::UPGRADES2, true, "", &dialoguesArray[5]);
	...
	dialoguesArray[17] = Dialogue(DialogueWindow::TUTO_FANG_ULTI, true, "", &dialoguesArray[18]);
	...
	dialoguesArray[23] = Dialogue(DialogueWindow::TUTO_ONIMARU_ULTI, true, "", &dialoguesArray[28]);
